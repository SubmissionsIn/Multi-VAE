...
Disentangling multi-view information&representation has a strict condition that it is clear what view-common information and view-peculiar/private information is going to be disentangled. In order to verify the disentanglement effectiveness of visual representations in Multi-VAE, we constructed two kinds of datasets as follows:

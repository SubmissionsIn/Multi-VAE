...
class Trainer():
    ...
    def _train_iteration(self, data):
        ...
        for i in range(self.view_num):
            ...
            Loss.append(self._loss_function(data[i], recon_batchs[i], {'cont': latent_dist[countinue_name], 'disc': latent_dist['disc']}, view=i, max_recon_loss=max_recon_loss))
        for i in range(self.view_num - 1):
    ...
    def _loss_function(self, data, recon_data, latent_dist, view=0, max_recon_loss=1000):
        """
